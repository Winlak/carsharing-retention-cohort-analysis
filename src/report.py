...
**График:** [когортная матрица в self-contained HTML handoff](../docs/visualization_handoff.html#cohort-heatmap).
...
**График:** [classical и rolling retention](../docs/visualization_handoff.html#retention-curves).
...
**График:** [D30 и число поездок в D1–D7](../docs/visualization_handoff.html#early-week).
...
**График:** [D30 и исход первой попытки](../docs/visualization_handoff.html#first-experience).
...
**График:** [распределение интервалов](../docs/visualization_handoff.html#ride-gaps).
